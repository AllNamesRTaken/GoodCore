...
describe('MocData',
    function() {
        it('NumericArray Generates linear and non linead int and float arrays',
            function(){
                let base = MocData.NumericArray(1);
