...
describe("Test", function () {
    ...
    it("hasFastNativeArrays should be true in node", function () {
    ...
    it("All is<browser> should be false in node", function () {
