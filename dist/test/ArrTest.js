...
describe("Arrays", function () {
    ...
    it("ShallowCopy references same inner objects", function () {
        ...
        lib_1.Test.Env.useNative = false;
        const copy2 = Arr.shallowCopy(arr);
        copy2[1].should.equal(arr[1]);
        Arr.shallowCopy(null).should.deep.equal([]);
        lib_1.Test.Env.useNative = undefined;
    });
    ...
    it("find return correct element or undefined", function () {
    ...
    it("Splice without native does splice", function () {
        lib_1.Test.Env.useNative = false;
        let arr1 = [1, 4, 7, 2];
        Arr.splice(arr1, -1, -1);
        arr1.should.deep.equal([1, 4, 7, 2]);
    ...
    it("Deserialize revives T[]", function () {
        class Revivable {
            deserialize(data) {
                this.foo = data + 1;
                return this;
