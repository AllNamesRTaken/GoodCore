...
describe("Range2", function () {
    ...
    it("Translate treats the range as a rectangle and multiplies each point with a vector", function () {
        const r1 = new Range2_1.Range2(1, 1, 2, 3);
        r1.translate(new Vec2_1.Vec2(2, 3)).equals(new Range2_1.Range2(2, 3, 4, 9)).should.be.true;
    });
    it("ToRect converts the range into a rect with end non-inclusive", function () {
        const r1 = new Range2_1.Range2(1, 1, 2, 3);
        r1.toRect().equals(new Rect_1.Rect(1, 1, 3, 4)).should.be.true;
        let endInclusive = r1.toRect(true);
        endInclusive.equals(new Rect_1.Rect(1, 1, 2, 3)).should.be.true;
        let endInclusiveNeg = (new Range2_1.Range2(1, 1, -2, -3)).toRect(true);
        endInclusiveNeg.equals(new Rect_1.Rect(1, 1, 0, -1)).should.be.true;
    });
    ...
    it("Intersect is true if another range is partially contained", function () {
        const r1 = new Range2_1.Range2(1, 1, 2, 3);
        const inside = new Range2_1.Range2(1, 1, 2, 2);
        const partially = new Range2_1.Range2(1, 1, 2, 4);
        const outside = new Range2_1.Range2(10, 10, 2, 4);
