...
describe("Rect", function () {
    ...
    it("Translate moved the rectangle by a vector", function () {
        const r1 = new Rect_1.Rect(1, 1, 3, 4);
        r1.translate(new Vec2_1.Vec2(2, 3)).equals(new Rect_1.Rect(3, 4, 5, 7)).should.be.true;
    });
    it("FromRange returns the correct rect", function () {
        const r1 = new Range2_1.Range2(1, 1, 3, 4);
        let rect1 = new Rect_1.Rect().fromRange2(r1);
        rect1.start.equals(new Vec2_1.Vec2(1, 1)).should.be.true;
        rect1.stop.equals(new Vec2_1.Vec2(4, 5)).should.be.true;
    });
    const r2 = new Range2_1.Range2(1, 1, -3, -4);
    let rect2 = new Rect_1.Rect().fromRange2(r2, true);
    rect2.start.equals(new Vec2_1.Vec2(1, 1)).should.be.true;
    rect2.stop.equals(new Vec2_1.Vec2(-1, -2)).should.be.true;
